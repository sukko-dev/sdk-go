...
//
// Several members are also errors (the typed error structs): one
...
// StateChange reports a connection-state transition, per the state machine.
...
//
// These are the typed error structs, defined in errors.go. Adding the

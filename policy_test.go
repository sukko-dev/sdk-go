...
// The four policy tables in policy.go are the single source that the
// termination classification and the *StateChange matrix are
...
// TestStateTransitions pins the entry/exit table, which this structure

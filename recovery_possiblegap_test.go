...
// TestPossibleGapDirectDegrade (Direct row): a channel granted but cursorless
...
// TestPossibleGapKafkaNoGap (Kafka row): a channel that held a cursor (a message
...
// TestPossibleGapNotAvailableDegrade (not_available row): a
